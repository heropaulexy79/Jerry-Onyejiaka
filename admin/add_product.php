...
if (isset($_POST['upload'])) {
  ...
  if (empty($_POST["book_desc"])) {
    ...
    $book_desc = test_input($_POST['book_desc']);
  }
  ...
  foreach (($_FILES["image"]["tmp_name"]) as $key => $tmp_name) {
    ...
    if (file_exists($UploadFolder . "/" . $name) == true) {
      $UploadOk = false;
      $errors .= $name . " file already exist.";
    }
    if ($UploadOk == true) {
      $imagename .= $name . "|";
  ...
  if ($input_err == "") {
    $insert = mysqli_query($conn, "INSERT INTO products (book_title, book_desc, price, picture, picture2, picture3) 
                VALUES('$book_title', '$book_desc', '$book_price', '$picture1', '$picture2', '$picture3')");
    if ($insert) {
      $status .= '<div class="alert alert-success">
      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      <strong>New Book was uploaded successfully!</strong>
</div>';
    } else {
      $status .= '<div class="alert alert-danger">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Unable to upload into the database currently, please try again later.</strong>
</div>';
    }
  } else {
    $status .= '<div class="alert alert-danger">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Unable to upload product, some field(s) are empty.</strong>
</div>';
  }
}
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav flex-column">
              ...
              <li class="nav-item ">
                <a class="nav-link active" href="add_product.php"><i class=" fas fa-upload"></i>Add Book</a>
              </li>
              <li class="nav-item ">
                <a class="nav-link" href="all_products.php"><i class=" fas fa-upload"></i>Email List</a>
              </li>
              <li class="nav-item ">
                ...
                <form method="POST" action="#" enctype="multipart/form-data">
                  <div class="form-row">
                    ...
                    <div class="form-group col-6">
                      <label for="inputText3" class="col-form-label">Book Title</label>
                      <input id="inputText3" type="text" name="book_title" class="form-control">
                      <?php echo "<div class='red'> $input_err</div>" ?>

                    </div>
                    <div class="form-group col-6">
                      <label for="inputText3" class="col-form-label">Book Description</label>
                      <input id="inputText3" type="text" name="book_desc" class="form-control">
                      <?php echo "<div class='red'> $input_err</div>" ?>
                  ...
                  <div class="form-group">
                    <label for="inputText4" class="col-form-label">Book Price</label>
                    <input id="inputText4" type="number" name="price" class="form-control" placeholder="Enter book price">
                    <?php echo "<div class='red'> $input_err</div>" ?>
